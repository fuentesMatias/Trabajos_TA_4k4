...
int displayUpdateInterval = 1000; // Intervalo de actualización del display (en milisegundos)
unsigned long lastDisplayUpdate = 0; // Último tiempo de actualización del display
...
void loop() {
  ...
  //---------------Escribir display--------------------
  // Actualizar el display si es necesario (cada cierto intervalo de tiempo)
  if (millis() - lastDisplayUpdate >= displayUpdateInterval) {
    lastDisplayUpdate = millis(); // Actualizar el tiempo de la última actualización del display
    //---------------Escribir display--------------------
